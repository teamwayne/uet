          ...
          var UETTAGS = {
            ...
            handleTagFire: function(tag, tagObj, brand) {
              ...
              if (!/retargeting\sslice\sallocation/i.test(tag)) {
                this.fireSplunk('&Uet=' + encodeURIComponent(tag) + '&domain=' + encodeURIComponent(window.location.hostname + window.location.pathname) + '&brand=' + encodeURIComponent(UET_UTILS.checkAppBrand()) + '&insurancetype=' + encodeURIComponent(tagObj.insuranceType) + '&catergory=' + encodeURIComponent(tagObj.category) + '&targetPage=' + encodeURIComponent(tagObj.targetPage) + '&pageId=' + encodeURIComponent(this.pageId));
              }
            },
            ...
            execute: function() {
              try {
                ...
                this.fireSplunk('&UetError=' + encodeURIComponent(error) + '&domain=' + encodeURIComponent(window.location.hostname) + '&brand=' + encodeURIComponent(brand) + '&pageId=' + encodeURIComponent(this.pageId) + '&appVersion=' + this.appVersion + '-' + UET_UTILS.container);
              }
            },
          };
          UETTAGS.execute();
